...
model_results = [
    ...
    (val_split.y, linear_prediction, 'Linear Regression'),
    (val_split.y, random_forest_prediction, 'Random Forest'),    
    (val_split.y, xg_prediction, 'XG Boost')
    ]

compare_all_models(model_results, risk_free_rate=0.0369)
